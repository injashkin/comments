(function(){const o=document.createElement("link").relList;if(o&&o.supports&&o.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))c(e);new MutationObserver(e=>{for(const s of e)if(s.type==="childList")for(const l of s.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&c(l)}).observe(document,{childList:!0,subtree:!0});function t(e){const s={};return e.integrity&&(s.integrity=e.integrity),e.referrerPolicy&&(s.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?s.credentials="include":e.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function c(e){if(e.ep)return;e.ep=!0;const s=t(e);fetch(e.href,s)}})();function C(n){const o={dateFormat:"",dateWord:"",timeFormat:""};let t=n;const c=new Date;t?typeof t=="string"?(t=new Date(t),o.timeFormat=i(c)):o.timeFormat=i(t):(t=c,o.timeFormat=i(c));const e=c-t,s=Math.floor(e/(84600*1e3));s<1&&(t=c);const l=t.getMonth(),m=t.getDate(),u=l<10?`0${l}`:`${l}`,r=m<10?`0${m}`:`${m}`;o.dateFormat=`${t.getFullYear()}-${u}-${r}`;function i(a){const d=a.getHours(),f=a.getMinutes(),p=d<10?`0${d}`:`${d}`,v=f<10?`0${f}`:`${f}`;return`${p}:${v}`}return s<1&&(o.dateWord="Сегодня"),s===1&&(o.dateWord="Вчера"),s===2&&(o.dateWord="Позавчера"),s>2&&s<5&&(o.dateWord=`${s} дня назад`),s>=5&&s<21&&(o.dateWord=`${s} дней назад`),s===21&&(o.dateWord=`${s} день назад`),s>21&&s<25&&(o.dateWord=`${s} дня назад`),s>=25&&(o.dateWord=`${s} дней назад`),o}function w(){let n,o;const t={left:"",top:"",opacity:""};document.addEventListener("mouseover",c),document.addEventListener("mouseout",m);function c(r){const i=r.target;let a=i.closest("[data-tooltip]");a&&(a.dataset.tooltip===""?e(a):l(a,i))}function e(r){o="complete",n=r.lastElementChild,t.left=n.style.left,t.top=n.style.top,t.opacity=n.style.opacity,s(r,n)}function s(r,i){let a=r.getBoundingClientRect(),d=a.left+(r.offsetWidth-i.offsetWidth)/2,f=a.top-i.offsetHeight,p=d+i.offsetWidth,v=f+i.offsetHeight;d<0&&(d=0),p>document.documentElement.clientWidth&&(d=document.documentElement.clientWidth-i.offsetWidth),f<0&&(f=a.top+r.offsetHeight),v>document.documentElement.clientHeight&&(f=document.documentElement.clientHeight-i.offsetHeight),i.style.left=`${d}px`,i.style.top=`${f}px`}function l(r,i){o="simple";let a=r.dataset.tooltip;n=document.createElement("div"),n.innerHTML=a,n.className="tooltip",i.after(n),s(r,n)}function m(){n&&o==="simple"&&n.remove(),n&&o==="complete"&&u(n)}function u(r){r.style.left=t.left,r.style.top=t.top,r.style.opacity=t.opacity}}const g="/assets/favorite-778060ce.svg",E="/assets/favorite_fill-e5400283.svg",L="/assets/delete-1daacdcf.svg",y=document.querySelector("#comments");w();document.addEventListener("click",b);document.addEventListener("keydown",W);function W(n){const o=n.target;if(n.code=="Enter"&&!n.shiftKey&&o.closest(".comments__form")){const t=o.closest(".comments__form"),c=t.querySelector(".comments__submit");if(!n.repeat){const e=new Event("click",{bubbles:!0,cancelable:!0});c.dispatchEvent(e),n.preventDefault(),_(t)&&S(t)}}}function b(n){const o=n.target;if(o.closest(".form-wrapper")){const t=o.closest(".form-wrapper"),c=t.querySelector(".comments__form"),e=t.querySelector(".appeal");e.classList.contains("hide")||(e.classList.add("hide"),h(c))}if(o.closest(".comments__submit")){const t=o.closest(".input-content"),c=t.querySelector(".appeal"),e=t.querySelector(".comments__form");if(!_(e))return;const s=S(e);t.after(s),t.closest(".children")?t.remove():($(e),h(c))}if(o.closest(".comment-delete")&&o.closest(".post-content").remove(),o.closest(".voting")){const t=o.closest(".voting"),c=t.querySelector("img"),e=t.querySelector(".count");c.getAttribute("src")===g?(c.setAttribute("src",E),e.textContent&&(e.textContent=(+e.textContent+1).toString())):(c.setAttribute("src",g),e.textContent&&(e.textContent=(+e.textContent-1).toString()))}if(o.closest(".reply")){if(y.querySelectorAll(".input-content").length>1){alert("У вас уже открыта форма");return}const c=o.closest(".post-wrapper"),e=y.querySelector(".input-content").cloneNode(!0);console.log(e);const s=document.createElement("div");s.classList.add("children"),c.append(s),s.append(e);const l=e.querySelector(".appeal"),m=e.querySelector(".comments__form");$(l),h(m)}}function S(n){const{user:o,comment:t,date:c}=n,{timeFormat:e,dateWord:s}=C(c.value);let l=o.value,m=[...l][0].toUpperCase(),u=document.createElement("div");return u.innerHTML=`
